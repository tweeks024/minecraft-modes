...
EGGS = {
    ...
    'darth_maul_spawn_egg': ((0xB0, 0x18, 0x10), (0x10, 0x10, 0x10)),
    ...
    'at_at_spawn_egg': ((0x6E, 0x71, 0x78), (0x3A, 0x3D, 0x42)),
    'band_droid_spawn_egg': ((0xB8, 0x73, 0x33), (0x2E, 0x2A, 0x26)),
    'chewbacca_spawn_egg': ((0x6B, 0x4A, 0x2E), (0x3A, 0x28, 0x1A)),
    'grogu_spawn_egg': ((0x8A, 0xA8, 0x6B), (0xC8, 0xA8, 0x7A)),
    'ewok_spawn_egg': ((0x6B, 0x4A, 0x2E), (0xA8, 0x89, 0x5E)),
    'rancor_spawn_egg': ((0x8A, 0x6A, 0x48), (0x3A, 0x28, 0x1A)),
    'jabba_spawn_egg': ((0x9A, 0x8E, 0x5A), (0x5A, 0x50, 0x30)),
    'palpatine_spawn_egg': ((0x24, 0x22, 0x28), (0xB8, 0xB0, 0xA0)),
}
