...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(com.tweeks.starwars.Registration.SABERSTAFF.get(), "Saberstaff");
        ...
        add(com.tweeks.starwars.ModEntities.DARTH_MAUL.get(), "Darth Maul");
        add(com.tweeks.starwars.Registration.DARTH_MAUL_SPAWN_EGG.get(), "Darth Maul Spawn Egg");
        ...
        add("starwars.planet.endor", "Endor");
        add("starwars.planet.mustafar", "Mustafar");
        add("starwars.planet.home", "Home");
        add(com.tweeks.starwars.Registration.RED_KYBER_ORE.get(), "Red Kyber Ore");
        ...
        add(com.tweeks.starwars.ModEntities.PALPATINE.get(), "Emperor Palpatine");
        ...
        add(com.tweeks.starwars.Registration.PALPATINE_SPAWN_EGG.get(), "Emperor Palpatine Spawn Egg");
