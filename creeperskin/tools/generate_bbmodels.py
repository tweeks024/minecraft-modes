...
Run with: python3 creeperskin/tools/generate_bbmodels.py
...
RESOURCES = ROOT / "src/main/resources/assets/creeperskin"
...
# -----------------------------------------------------------------------------
# Tuple format: (name, from, to, origin, (uv_u, uv_v), mirror)
# Sizes:
...
def box_faces(size_w, size_h, size_d, uv_u, uv_v):
    ...
    uv_offset (U, V). Mirrors the convention dumped from baton.bbmodel."""
...
# -----------------------------------------------------------------------------
# Texture record (mirrors the security_guard.bbmodel format)
# -----------------------------------------------------------------------------
