...
/**
 * Renderer for {@link SherrifEntity}: vanilla {@link HumanoidModel} baked from
 * {@link ModelLayers#PLAYER}, sherrif texture, plus {@link WildWestHeldItemLayer}
...
public class SherrifRenderer
        extends HumanoidMobRenderer<SherrifEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
